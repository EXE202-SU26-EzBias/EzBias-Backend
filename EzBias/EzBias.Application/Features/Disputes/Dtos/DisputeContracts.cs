...
public record DisputeListItemResponse(long Id, long OrderId, long InitiatorId, string Status, string Reason, string? AdminNote, DateTimeOffset CreatedAt, DateTimeOffset? ResolvedAt, DisputeRefundPayoutInfo? RefundPayoutInfo, IReadOnlyList<DisputeItemResponse> Items);

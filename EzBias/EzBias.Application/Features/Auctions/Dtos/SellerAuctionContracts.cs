...
public record SellerAuctionItem(long AuctionId, long ProductId, decimal FloorPrice, decimal CurrentBid, AuctionStatus Status, DateTimeOffset EndsAt, DateTimeOffset CreatedAt);

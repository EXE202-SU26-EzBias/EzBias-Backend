...
using EzBias.Infrastructure.Integrations;
...
builder.Services.AddScoped<IDeliveredOrderFinalizationApplicationService, DeliveredOrderFinalizationApplicationService>();
builder.Services.AddScoped<IPayoutApplicationService, PayoutApplicationService>();
builder.Services.AddScoped<IProductReviewApplicationService, ProductReviewApplicationService>();
